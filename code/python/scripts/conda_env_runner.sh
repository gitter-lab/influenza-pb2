#!/bin/sh
# wrapper script to run a python program in a conda environment 

# TODO implement getoptlong style interface
usage="conda_env_runner.sh <env> <cmd> <args>"
...
# TODO sourcing the correct conda setup if its in ~/.bash_profile renders this unnecessary 
